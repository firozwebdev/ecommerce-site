                ...
                <div class="table-row">
                                            ...
                                            <ul class="main-nav">
                                                ...
                                                ?>
                                                    ...
                                                    <li class="dropdown mega-menu">
                                                        ...
                                                        <!-- menu images -->
                                                        <a href="{{route('menu',$menu->id.'-'.str_slug($menu->name))}}" class="dropdown-link">
                                                            <span>{{$menu->name}}</span>
                                                        </a>
                    ...
                    <div class="header-search-menu">
                        ...
                        <div class="searchbox d-none d-lg-block">
                          <form id="search" class="navbar-form search" method="GET" action="{{ url('index') }}">


                             <!-- <input type="hidden" name="type" value="product" /> -->
                             <input id="search_product" name="search_product" type="text" class="form-control" placeholder="Search" />


                                <div class="search-all-categories-dropdown">
                                    <select class="custom-select search-all-categories-btn" id="inputGroupSelect01" onchange="location = this.value;" >
                                        <?php $searchCategoryValue = 0; ?>
                                            <option value="<?php echo $searchCategoryValue; ?>" selected>All Categories</option>
                                            @foreach($product_menus as $menu)
                                            <?php $searchCategoryValue++; ?>
                                               <option value="{{route('menu',$menu->id)}}">{{$menu->name}}</option>
                                                @endforeach
                                    </select>
                                </div>
            ...
            <div class="nav-collapse is-mobile-nav">
                <ul class="main-nav">
                    ...
                    <li class="dropdown mega-menu">
                        ...
                        <div class="dropdown-menu position-left" style="width: 100%;min-height: 190px; background: url({{asset('frontEnd/assets/img/mega_menu_bg_img_1.jpg')}}) no-repeat top right #fff;">
